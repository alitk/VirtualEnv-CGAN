...
class GAN:
    def __init__(self, output_shape, n_epochs = 200, batch_size= 64, lr= 0.0002, b1= 0.5, 
                ...
                sample_interval= 400, clip_value = 0.01, n_critic = 5):
    ...
    def train(self,input_data):
        ...
        for epoch in range(self.n_epochs):
            for i, batch_data in enumerate(dataloader):
                ...
                gen_output = self.generator(z).detach()
                loss_D = -torch.mean(self.discriminator(real_output)) + torch.mean(self.discriminator(gen_output))
                ...
                if i % self.n_critic == 0:
                    ...
                    print(
                        ...
                        % (epoch, self.n_epochs, batches_done % len(dataloader), len(dataloader), loss_D.item(), loss_G.item())
                    )
